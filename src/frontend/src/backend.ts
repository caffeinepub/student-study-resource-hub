...
export class Backend implements backendInterface {
    ...
    async addSuggestion(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addSuggestion(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllSuggestions(): Promise<Array<[bigint, Suggestion]>> {
        if (this.processError) {
            try {
    ...
    async getSuggestion(arg0: bigint): Promise<Suggestion> {
        if (this.processError) {
            try {
    ...
    async updateSuggestion(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSuggestion(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
